...
impl<T: Config> Pallet<T> {
    ...
    ///
    ///  * 'incentive': ( bool ):
    ///     - default=False called “incentive” in the epoch parameters that,
    ///       if set to “True”, will return the incentive storage value as Vec<I32F32> instead of the emission tuples.
    ///
    ///  * 'debug' ( bool ):
    ...
    pub fn epoch(
        ...
        // Compute rao based emission scores. range: I96F32(0, rao_emission)
        let rao_emission: u64 = Self::get_rao_emission(netuid);
        let float_rao_emission: I96F32 = I96F32::from_num(rao_emission);
